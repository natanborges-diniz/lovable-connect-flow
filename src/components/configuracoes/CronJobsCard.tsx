...
const CRON_DETAILS: Record<string, CronDetail> = {
  ...
  "vendas-recuperacao-cron": {
    ...
    parametros: [
      { key: "delay_primeira_tentativa", label: "Delay para 1ª tentativa", type: "number", defaultValue: 1, unit: "h", min: 1, max: 168 },
      { key: "delay_segunda_tentativa", label: "Delay para 2ª tentativa (após a 1ª)", type: "number", defaultValue: 24, unit: "h", min: 1, max: 168 },
      { key: "espera_para_despedida", label: "Espera para mensagem de despedida (após 2ª)", type: "number", defaultValue: 1, unit: "h", min: 1, max: 168 },
      { key: "max_tentativas", label: "Máx. tentativas de recuperação", type: "number", defaultValue: 2, unit: "x", min: 1, max: 5 },
